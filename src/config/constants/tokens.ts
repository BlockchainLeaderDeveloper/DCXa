...
export const AMA: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
...
export const DCXa: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0x00495f363ec5a7369a4cb1b62b5dff4ae03f9c22',
    9,
    'DCXa',
    'Diverse Capital of Asiatic Exchanges',
  ),
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x00495f363ec5a7369a4cb1b62b5dff4ae03f9c22',
...
const tokens = {
  ...
  dcxa: {
    ...
    decimals: 9,
    projectLink: 'https://amabscswap.com/',
  },
  ama: {
    symbol: 'AMA',
    address: {
      56: '0xFC3dA4A1b6faDaB364039525dD2AB7c0c16521cd',
      97: '',
    },
    decimals: 18,
    projectLink: 'https://amabscswap.com/',
