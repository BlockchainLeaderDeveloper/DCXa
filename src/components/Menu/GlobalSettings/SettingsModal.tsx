    ...
    >
      <Flex flexDirection="column">
        <Flex pb="24px" flexDirection="column">
          <Text bold textTransform="uppercase" fontSize="12px" color="#0fddf6" mb="24px">
            {t('Global')}
          </Text>
          <GasSettings />
        </Flex>
        ...
        <Flex justifyContent="space-between" alignItems="center" mb="24px">
          <Flex alignItems="center">
            <Text color='#2a9727'>{t('Expert Mode')}</Text>
            <QuestionHelper
        ...
        <Flex justifyContent="space-between" alignItems="center" mb="24px">
          <Flex alignItems="center">
            <Text color='#2a9727'>{t('Disable Multihops')}</Text>
        ...
        <Flex justifyContent="space-between" alignItems="center">
          <Flex alignItems="center">
            <Text color='#2a9727'>{t('Flippy sounds')}</Text>
            <QuestionHelper
